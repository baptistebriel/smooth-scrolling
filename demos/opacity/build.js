...
var Smooth = function () {
    ...
    _createClass(Smooth, [{
        ...
        value: function addFakeScrollBar() {
            ...
            (0, _domEvent.on)(this.dom.scrollbar.el, 'click', this.calcScroll);
            (0, _domEvent.on)(this.dom.scrollbar.el, 'mousedown', this.mouseDown);

            (0, _domEvent.on)(document, 'mousemove', this.mouseMove);
            (0, _domEvent.on)(document, 'mouseup', this.mouseUp);
        }
    }, {
        ...
        value: function removeFakeScrollBar() {
            ...
            (0, _domEvent.off)(document, 'mousemove', this.mouseMove);
            (0, _domEvent.off)(document, 'mouseup', this.mouseUp);
...
},{"dom-classes":11,"dom-create-element":12,"dom-css":13,"dom-event":15,"perfnow":19,"prefix":20,"virtual-scroll":26}],4:[function(require,module,exports){
...
},{"base64-js":5,"ieee754":16,"isarray":8}],8:[function(require,module,exports){
...
},{"indexof":17}],12:[function(require,module,exports){
/*
`dom-create-element`
...
},{"add-px-to-style":4,"prefix-style":14,"to-camel-case":22}],14:[function(require,module,exports){
var div = null
...
},{"./clone":25,"./support":27,"bindall-standalone":6,"defaults":10,"lethargy":18,"tiny-emitter":21}],27:[function(require,module,exports){
'use strict';
