...
function (_Smooth) {
  ...
  _createClass(Parallax, [{
    ...
    value: function resize() {
      ...
      this.dom.scroll.style.height = "".concat(this.vars.bounding, "px");
      this.resizing = false;
    }
  }, {
    key: "getCache",
    value: function getCache() {
      ...
      this.dom.section.style.width = "".concat(this.vars.width, "px");
    ...
    value: function run() {
      ...
      this.dom.section.style[this.prefix] = "translate3d(".concat(this.vars.current * -1, "px,0,0)");
